...
const InfrastructureSection = () => {
  ...
  return (
    <Box id="infrastructure" sx={infrastuctureStyles.container}>
      <Box sx={infrastuctureStyles.grid}>
        ...
        <Box sx={infrastuctureStyles.des}>
          <Typography>
            ...
            businesses—from expanding internationally to reimagining the
            customer experience.
          </Typography>
        </Box>
                    ...
                    <Button
                      ...
                      endIcon={
                        <Box sx={infrastuctureStyles.iconSwap}>
                          ...
                          />
                          <ArrowForwardIcon
                            sx={infrastuctureStyles.arrowIcon}
                          />
                        </Box>
                      }
        ...
        <Box sx={infrastuctureStyles.platformsSection}>
          ...
          <Box sx={infrastuctureStyles.des}>
            <Typography>
              ...
              platforms use Stripe to expand their product offerings with
                ...
                return (
                  <Box key={feature.id} sx={infrastuctureStyles.expertColumn}>
                    ...
                    <Typography sx={infrastuctureStyles.expertText}>
                      <Box
                        component="span"
                        sx={infrastuctureStyles.expertTitle}
                      >
                        {feature.title}
                      </Box>{" "}
                      {feature.description}
